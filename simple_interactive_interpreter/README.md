...
> Done! A bit over the top, getting ready for next kata, with function definition.

>> It's actually a pretty serviceable calculator. Could even add differentiation, numerical or symbolic, from other katas, and it's Mathematica, lol.
