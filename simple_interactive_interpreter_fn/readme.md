...
Operator precedence will follow the common order. There is a table in the [Language](#language) section below that explicitly states the operators and their relative precedence.
