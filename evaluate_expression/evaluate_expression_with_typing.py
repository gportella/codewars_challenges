...
class Add:
    ...
    def __init__(self, terms: Tuple[object, ...]):
        self.terms = terms
...
class Mul:
    ...
    def __init__(self, factors: Tuple[object, ...]):
...
class Div:
    ...
    def __init__(
        self, num_factors: Tuple[object, ...], denum_factors: Tuple[object, ...]
    ):
...
class Pow:
    ...
    def __init__(self, base: object, exp: object):
        self.base = base
        self.exp = exp
